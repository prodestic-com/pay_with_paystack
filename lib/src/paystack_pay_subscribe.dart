...
class PaystackPaySubscribe extends StatefulWidget {
  ...
  @override
  State<PaystackPaySubscribe> createState() => _PaystackPaySubscribeState();
}

class _PaystackPaySubscribeState extends State<PaystackPaySubscribe> {
