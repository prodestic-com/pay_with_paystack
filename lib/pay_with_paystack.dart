...
import 'package:pay_with_paystack/src/paystack_pay_subscribe.dart';
...
class PayWithPayStack {
  ...
  Future<dynamic> subscribe({
    ...
    /// Alpha numeric and/or number plan you to subscribe to
    ...
    return Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => PaystackPaySubscribe(
                secretKey: secretKey,
                email: customerEmail,
                reference: reference,
                plan: plan,
